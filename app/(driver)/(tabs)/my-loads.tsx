...
const styles = StyleSheet.create({
  ...
  createButton: { borderRadius: 8, paddingHorizontal: 16, paddingVertical: 10, backgroundColor: '#007AFF' },
  ...
  bidsButton: { alignSelf: 'flex-start', borderRadius: 8, paddingHorizontal: 18, paddingVertical: 10, backgroundColor: '#007AFF', marginTop: 4 },
